  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <Select value={value ?? ''} onValueChange={(v) => onChange(v || '')}>
        <SelectTrigger className="data-[size=default]:h-9 w-full rounded-lg border-brand-neutral-200 focus:border-brand-primary-600 focus:ring-2 focus:ring-brand-primary-600/10" disabled={disabled}>
