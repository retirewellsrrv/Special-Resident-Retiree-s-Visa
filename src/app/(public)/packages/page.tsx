...
export default function Services() {
    ...
    useEffect(() => {
        ...
        <div className="min-h-screen bg-[#FAFAFA] font-sans text-slate-800 flex flex-col">
            ...
            {/* Hero Section */}
            <Hero title="Our Retirement Packages" description="Explore our tailored visa pathways and concierge programs designed to make your transition to retiring in the Philippines entirely seamless."/>
